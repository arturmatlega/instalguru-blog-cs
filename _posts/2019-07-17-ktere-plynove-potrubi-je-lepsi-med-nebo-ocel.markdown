...
- question: Jak pájet měděné trubky?
  answer: Pokud nejste profesionál, nepokoušejte se pájet plynové potrubí. Nejlepší
    je najmout specialistu, který to bude dělat rychle a bezpečně.
- question: Jak připojit PVC potrubí?
  answer: Můžete připojit PVC trubici lepením. Zakryjte konce obou prvků lepidlem
    a pak naneste lepidlo. Jedná se o velmi snadný způsob připojení trubice z PVC.
- question: Jak dlouho měděné trubky vydrží?
  answer: Měděné trubky obvykle vydrží asi 20 let. Tento typ potrubního materiálu,
    který je řádně udržován, může trvat až 50 let - v některých případech ještě déle.
- question: Co je PVC potrubí?
  answer: Zkratka PVC znamená polyvinylchlorid. V nedávné době je běžné nahradit kovové
    trubky PVC trubkami ve vodních zařízeních.
